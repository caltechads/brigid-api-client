...
T = TypeVar("T", bound="PatchedAWSECSTask")


@attr.s(auto_attribs=True)
class PatchedAWSECSTask:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if task_family is not UNSET:
            field_dict["task_family"] = task_family
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        task_family = d.pop("task_family", UNSET)
        ...
        patched_awsecs_task.additional_properties = d
        return patched_awsecs_task
