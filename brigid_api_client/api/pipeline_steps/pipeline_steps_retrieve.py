...
from ...models.pipeline_steps_retrieve_expand import PipelineStepsRetrieveExpand
...
def _get_kwargs(
    *,
    ...
    id: int,
    expand: Union[Unset, PipelineStepsRetrieveExpand] = UNSET,
) -> Dict[str, Any]:
    ...
    json_expand: Union[Unset, PipelineStepsRetrieveExpand] = UNSET
