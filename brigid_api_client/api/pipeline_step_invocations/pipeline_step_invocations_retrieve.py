...
from ...models.pipeline_step_invocations_retrieve_expand import (
...
def _get_kwargs(
    *,
    ...
    id: int,
    expand: Union[Unset, PipelineStepInvocationsRetrieveExpand] = UNSET,
) -> Dict[str, Any]:
    ...
    json_expand: Union[Unset, PipelineStepInvocationsRetrieveExpand] = UNSET
