...
from ...models.applications_retrieve_expand import ApplicationsRetrieveExpand
...
def _get_kwargs(
    *,
    ...
    id: int,
    expand: Union[Unset, ApplicationsRetrieveExpand] = UNSET,
) -> Dict[str, Any]:
    ...
    json_expand: Union[Unset, ApplicationsRetrieveExpand] = UNSET
