...
from ...models.aws_tasks_retrieve_expand import AwsTasksRetrieveExpand
...
def _get_kwargs(
    *,
    ...
    id: int,
    expand: Union[Unset, AwsTasksRetrieveExpand] = UNSET,
) -> Dict[str, Any]:
    ...
    json_expand: Union[Unset, AwsTasksRetrieveExpand] = UNSET
