...
from ...models.aws_clusters_retrieve_expand import AwsClustersRetrieveExpand
...
def _get_kwargs(
    *,
    ...
    id: int,
    expand: Union[Unset, AwsClustersRetrieveExpand] = UNSET,
) -> Dict[str, Any]:
    ...
    json_expand: Union[Unset, AwsClustersRetrieveExpand] = UNSET
