...
from ...models.aws_services_retrieve_expand import AwsServicesRetrieveExpand
...
def _get_kwargs(
    *,
    ...
    id: int,
    expand: Union[Unset, AwsServicesRetrieveExpand] = UNSET,
) -> Dict[str, Any]:
    ...
    json_expand: Union[Unset, AwsServicesRetrieveExpand] = UNSET
